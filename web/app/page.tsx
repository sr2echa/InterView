...
export default function HomePage() {
  ...
  // Handle frame expansion/contraction
  ...
  // Handle monitor click to expand/contract
  ...
  // Handle connection animation and auto-switch to web view
  const handleConnect = () => {
  ...
  return (
    <main className="min-h-screen h-[100dvh] bg-black text-white flex flex-col overflow-x-hidden overflow-y-auto md:overflow-hidden">
      ...
      <section className="flex-1 flex flex-col lg:flex-row items-center justify-start lg:justify-center px-4 sm:px-8 py-4 lg:py-0 gap-8 lg:gap-12 max-w-7xl mx-auto w-full h-full overflow-y-auto lg:overflow-visible">
        ...
        {/* Enhanced Preview Section with interactive overlapping windows */}
        <div
            ...
            <div
              className={`absolute inset-0 z-${
                ...
                activePreview === "client"
                  ? "translate-x-0 translate-y-0 opacity-100 scale-100"
                  : "translate-x-2 xs:translate-x-3 sm:translate-x-4 md:translate-x-6 translate-y-1 xs:translate-y-1.5 sm:translate-y-2 md:translate-y-3 opacity-85 scale-[0.97]"
              }`}
